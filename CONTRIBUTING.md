...
Welcome to `storj-uplink` contributor's guide.
...
If you experience bugs or general issues with `storj-uplink`, please have a look
...
You can help improve `storj-uplink` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`storj-uplink` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `storj-uplink`'s files. While this mechanism can
...
```
conda create -n storj-uplink python=3 six virtualenv pytest pytest-cov
conda activate storj-uplink
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/storj-uplink.git
   cd storj-uplink
   ```
...
5. Install [pre-commit]:
   ...
   `storj-uplink` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/storj-uplink
[issue tracker]: https://github.com/<USERNAME>/storj-uplink/issues
